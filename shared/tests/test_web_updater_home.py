...
class HomeSelectionTests(unittest.TestCase):
    ...
    def test_home_page_omits_weekly_section_and_uses_support_credit_badge(self) -> None:
        ...
        self.assertIn("적재적소 브리프", footer_html)
...
class ProductRebuildTests(unittest.TestCase):
    def test_editorial_title_routes_to_public_home_and_lab_banner_stays_external(self) -> None:
        self.assertIn(
            'class="editorial-brand" href="index.html" aria-label="적재적소 브리프 홈으로"',
    ...
    def test_article_share_uses_native_share_with_copy_fallback(self) -> None:
        ...
        self.assertIn("적재적소 브리프에서 원문과 관련 자료를 확인해 보세요.", script)
    ...
    def test_operator_page_states_identity_standard_and_limits(self) -> None:
        ...
        self.assertIn("적재적소 연구소", page_html)
        self.assertIn("운영·편집 주체", page_html)
